...
const QuizComponent = () => {
    ...
    useEffect(() => {
        const getFanlar = async () => {
            try {
                const response = await axios.get("https://sinftest7-k14w.onrender.com/test/fanlar");
    ...
    const handleFanChange = async (fanId) => {
        ...
        try {
            const response = await axios.get(`https://sinftest7-k14w.onrender.com/test/savollar/${fanId}`);
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await axios.post("https://sinftest7-k14w.onrender.com/test/tekshirJavoblar", {
